...
class MomentQueryClient extends $grpc.Client {
  static final _$findOne = $grpc.ClientMethod<$0.StringValue, $2.MomentEntity>(
      '/odroe.socfony.MomentQuery/FindOne',
      ($0.StringValue value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.MomentEntity.fromBuffer(value));
  static final _$findMany =
      $grpc.ClientMethod<$2.MomentFindManyRequest, $2.MomentEntityList>(
          '/odroe.socfony.MomentQuery/FindMany',
          ($2.MomentFindManyRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $2.MomentEntityList.fromBuffer(value));
  static final _$search =
      $grpc.ClientMethod<$0.StringValue, $2.MomentEntityList>(
          '/odroe.socfony.MomentQuery/Search',
          ($0.StringValue value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $2.MomentEntityList.fromBuffer(value));

  MomentQueryClient($grpc.ClientChannel channel,
      {$grpc.CallOptions? options,
      $core.Iterable<$grpc.ClientInterceptor>? interceptors})
      : super(channel, options: options, interceptors: interceptors);

  $grpc.ResponseFuture<$2.MomentEntity> findOne($0.StringValue request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$findOne, request, options: options);
  }

  $grpc.ResponseFuture<$2.MomentEntityList> findMany(
      $2.MomentFindManyRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$findMany, request, options: options);
  }

  $grpc.ResponseFuture<$2.MomentEntityList> search($0.StringValue request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$search, request, options: options);
  }
}

abstract class MomentQueryServiceBase extends $grpc.Service {
  $core.String get $name => 'odroe.socfony.MomentQuery';

  MomentQueryServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.StringValue, $2.MomentEntity>(
        'FindOne',
        findOne_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.StringValue.fromBuffer(value),
        ($2.MomentEntity value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$2.MomentFindManyRequest, $2.MomentEntityList>(
            'FindMany',
            findMany_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $2.MomentFindManyRequest.fromBuffer(value),
            ($2.MomentEntityList value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.StringValue, $2.MomentEntityList>(
        'Search',
        search_Pre,
        false,
        false,
  ...
  $async.Future<$2.MomentEntity> findOne_Pre(
      $grpc.ServiceCall call, $async.Future<$0.StringValue> request) async {
    return findOne(call, await request);
  }

  $async.Future<$2.MomentEntityList> findMany_Pre($grpc.ServiceCall call,
      $async.Future<$2.MomentFindManyRequest> request) async {
    return findMany(call, await request);
  }

  $async.Future<$2.MomentEntityList> search_Pre(
      $grpc.ServiceCall call, $async.Future<$0.StringValue> request) async {
    return search(call, await request);
  }

  $async.Future<$2.MomentEntity> findOne(
      $grpc.ServiceCall call, $0.StringValue request);
  $async.Future<$2.MomentEntityList> findMany(
      $grpc.ServiceCall call, $2.MomentFindManyRequest request);
  $async.Future<$2.MomentEntityList> search(
      $grpc.ServiceCall call, $0.StringValue request);
}

class MomentMutationClient extends $grpc.Client {
  static final _$create =
      $grpc.ClientMethod<$2.CreateMomentRequest, $2.MomentEntity>(
          '/odroe.socfony.MomentMutation/Create',
          ($2.CreateMomentRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $2.MomentEntity.fromBuffer(value));
  static final _$delete = $grpc.ClientMethod<$0.StringValue, $1.Empty>(
      '/odroe.socfony.MomentMutation/Delete',
      ($0.StringValue value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Empty.fromBuffer(value));

  MomentMutationClient($grpc.ClientChannel channel,
      {$grpc.CallOptions? options,
      $core.Iterable<$grpc.ClientInterceptor>? interceptors})
      : super(channel, options: options, interceptors: interceptors);

  $grpc.ResponseFuture<$2.MomentEntity> create($2.CreateMomentRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$create, request, options: options);
  }

  $grpc.ResponseFuture<$1.Empty> delete($0.StringValue request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$delete, request, options: options);
  }
}

abstract class MomentMutationServiceBase extends $grpc.Service {
  $core.String get $name => 'odroe.socfony.MomentMutation';

  MomentMutationServiceBase() {
    $addMethod($grpc.ServiceMethod<$2.CreateMomentRequest, $2.MomentEntity>(
        'Create',
        create_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.CreateMomentRequest.fromBuffer(value),
        ($2.MomentEntity value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.StringValue, $1.Empty>(
        'Delete',
        delete_Pre,
  ...
  $async.Future<$2.MomentEntity> create_Pre($grpc.ServiceCall call,
      $async.Future<$2.CreateMomentRequest> request) async {
    return create(call, await request);
  }
  ...
  $async.Future<$2.MomentEntity> create(
      $grpc.ServiceCall call, $2.CreateMomentRequest request);
  $async.Future<$1.Empty> delete(
      $grpc.ServiceCall call, $0.StringValue request);
}

class HelloServiceClient extends $grpc.Client {
  static final _$sayHello = $grpc.ClientMethod<$0.StringValue, $0.StringValue>(
      '/odroe.socfony.HelloService/SayHello',
      ($0.StringValue value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.StringValue.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.StringValue> sayHello($0.StringValue request,
      {$grpc.CallOptions? options}) {
...
abstract class HelloServiceBase extends $grpc.Service {
  $core.String get $name => 'odroe.socfony.HelloService';
  ...
  $async.Future<$0.StringValue> sayHello_Pre(
      $grpc.ServiceCall call, $async.Future<$0.StringValue> request) async {
    return sayHello(call, await request);
  }

  $async.Future<$0.StringValue> sayHello(
      $grpc.ServiceCall call, $0.StringValue request);
}
