...
export class VerificationCodeMessage extends SendSmsMessageOptions {
    ...
    static async createMessage(prisma: PrismaClient, to: string): Promise<VerificationCodeMessage> {
        ...
        return new VerificationCodeMessage(to, options.value as unknown as DatebaseSettingOptions);
    }
}
